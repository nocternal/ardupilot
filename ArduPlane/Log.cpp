...
struct PACKED log_Performance {
    ...
    //uint32_t g_dt_max; // I MaxT
    //uint32_t g_dt_min; // I MinT
...
struct PACKED log_Nav_Tuning {
    ...
    int16_t airspeed_cm;
    uint16_t ju_yawc;
//    float   xtrack_error;   //f XT
//    float   xtrack_error_i; //f XTi
//    float   airspeed_error; //f ArspdErr
};
...
const struct LogStructure Plane::log_structure[] = {
    ...
    { LOG_PERFORMANCE_MSG, sizeof(log_Performance), 
      "PM",  "QHHIhhf",  "TimeUS,NLon,NLoop,LogDrop,ptchout,rollout,Jyerr" },
