...
const AP_Param::Info Plane::var_info[] = {
    ...
    // @Values: 0:Manual,1:CIRCLE,2:STABILIZE,3:TRAINING,4:ACRO,5:FBWA,6:FBWB,7:CRUISE,8:AUTOTUNE,10:Auto,11:RTL,12:Loiter,14:AVOID_ADSB,15:Guided,17:QSTABILIZE,18:QHOVER,19:QLOITER,20:QLAND,21:QRTL,22:JUHdotVPhi,23:JUGround,24:JUMANUAL
    // @User: Standard
...
///
    ...
    // @Param: JU_Lim_V_Avd0_Max
    // @DisplayName: JU_Lim_V_Avd0_Max
    ...
    // @Values: 1 10
    // @User: Advanced
    GSCALAR(JU_Lim_Hdot2Vdot_Max,         "JU_Lim_Hd2Vd_Max",   2),
    ...
    // @Description: JUHdotVPhi Mode Hdot Referemce Model's time constant of hdot[s] 
    // @Values: 0.1 5
    // @User: Advanced
    GSCALAR(JU_Ref_T_Hdot,         "JU_Ref_T_Hdot",   0.95),

    // @Param: JU_Ref_T_Hdotdot
    // @DisplayName: JU_Ref_T_Hdotdot
    // @Description: JUHdotVPhi Mode Hdot Referemce Model's time constant of hdotdot[s] 
    // @Values: 0.1 5
    // @User: Advanced
